...
const ADDIMPORTSCOMMAND: vscode.Disposable = vscode.commands.registerCommand('theiatutorialextension.addImports', (autoImportData: Array<autoImportData>) => {

    const workspaceFolder: string = vscode.workspace.rootPath || '~';

    let requir: {imports: string[], path: string[]} = {
